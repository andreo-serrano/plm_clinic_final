        ...
        @endphp
            ...
            <div class="w-full flex flex-col text-sm px-32 gap-3 mt-5">
                <div class="flex flex-row gap-3">
                    ...
                    <input type="text" class="w-full border-2 border-yellow-700 rounded-lg py-1 px-3 placeholder-yellow-700/[.7] font-bold" placeholder="{{ $doctorInfo->lastname }}" disabled>
                </div>

                <div class="flex flex-row gap-3">
                    <h2 class="font-bold py-1 bg-blue-900 text-white w-full text-end px-5 rounded-lg">FIRST NAME:</h2>
                    <input type="text" class="w-full border-2 border-yellow-700 rounded-lg py-1 px-3 placeholder-yellow-700/[.7] font-bold" placeholder="{{ $doctorInfo->firstname }}" disabled>
                </div>

                <div class="flex flex-row gap-3">
                    <h2 class="font-bold py-1 bg-blue-900 text-white w-full text-end px-5 rounded-lg">MIDDLE NAME:</h2>
                    <input type="text" class="w-full border-2 border-yellow-700 rounded-lg py-1 px-3 placeholder-yellow-700/[.7] font-bold" placeholder="{{ $doctorInfo->midname }}" disabled>
                </div>

                <div class="flex flex-row gap-3">
                    <h2 class="font-bold py-1 bg-blue-900 text-white w-full text-end px-5 rounded-lg">BIRTHDAY:</h2>
                    <input type="text" class="w-full border-2 border-yellow-700 rounded-lg py-1 px-3 placeholder-yellow-700/[.7] font-bold" placeholder="{{ $doctorInfo->birthdate }}" disabled>
                </div>

                <div class="flex flex-row gap-3">
                    <h2 class="font-bold py-1 bg-blue-900 text-white w-full text-end px-5 rounded-lg">GENDER:</h2>
                    <input type="text" class="w-full border-2 border-yellow-700 rounded-lg py-1 px-3 placeholder-yellow-700/[.7] font-bold" placeholder="{{ $doctorInfo->gender }}" disabled>
                </div>

                <div class="flex flex-row gap-3">
                    <h2 class="font-bold py-1 bg-blue-900 text-white w-full text-end px-5 rounded-lg">SPECIALIZATION:</h2>
                    <input type="text" class="w-full border-2 border-yellow-700 rounded-lg py-1 px-3 placeholder-yellow-700/[.7] font-bold" placeholder="{{ $doctorInfo->spec }}" disabled>
                </div>

                <div class="flex flex-row gap-3">
                    <h2 class="font-bold py-1 bg-blue-900 text-white w-full text-end px-5 rounded-lg">OFFICIAL PLM EMAIL:</h2>
                    <input type="text" class="w-full border-2 border-yellow-700 rounded-lg py-1 px-3 placeholder-yellow-700/[.7] font-bold" placeholder="{{ $doctorInfo->plmemail }}" disabled>
                </div>

                <div class="flex flex-row gap-3">
                    <h2 class="font-bold py-1 bg-blue-900 text-white w-full text-end px-5 rounded-lg">PERSONAL EMAIL:</h2>
                    <input type="text" class="w-full border-2 border-yellow-700 rounded-lg py-1 px-3 placeholder-yellow-700/[.7] font-bold" placeholder="{{ $doctorInfo->peremail }}" disabled>
                </div>

                <div class="flex flex-row gap-3">
                    <h2 class="font-bold py-1 bg-blue-900 text-white w-full text-end px-5 rounded-lg">MOBILE NUMBER:</h2>
                    <input type="text" class="w-full border-2 border-yellow-700 rounded-lg py-1 px-3 placeholder-yellow-700/[.7] font-bold" placeholder="{{ $doctorInfo->mobnum }}" disabled>
                </div>

                <div class="flex flex-row gap-3">
                    <h2 class="font-bold py-1 bg-blue-900 text-white w-full text-end px-5 rounded-lg">EMERGENCY NUMBER:</h2>
                    <input type="text" class="w-full border-2 border-yellow-700 rounded-lg py-1 px-3 placeholder-yellow-700/[.7] font-bold" placeholder="{{ $doctorInfo->ermobnum }}" disabled>
                </div>
                            ...
                            <div class="p-3 space-y-4 text-center">
                                ...
                                <div class="flex flex-col gap-3">
                                    <div class="w-full text-start">
                                        ...
                                        <input type="email" name="peremail" id="peremail" class="border border-blue-800 rounded-xl w-full py-1" value="{{ $doctorInfo->peremail }}">
                                    </div>

                                    <div class="w-full text-start">
                                        <label class="text-yellow-700">Mobile Number:</label>
                                        <input type="text" name="mobnum" id="mobnum" class="border border-blue-800 rounded-xl w-full py-1" value="{{ $doctorInfo->mobnum }}">
                                    </div>

                                    <div class="w-full text-start">
                                        <label class="text-yellow-700">Emergency Number:</label>
                                        <input type="text" name="gnum" id="gnum" class="border border-blue-800 rounded-xl w-full py-1" value="{{ $doctorInfo->ermobnum }}">
                                    </div>
                                </div>
